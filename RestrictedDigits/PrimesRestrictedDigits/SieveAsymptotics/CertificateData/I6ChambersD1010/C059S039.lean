...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C059S037
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C059S038

/-!
# exact I6 chamber certificate C059S039
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 2 (3 / 4) C059S037.tree C059S038.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C059S037.root_eq_path] using C059S037.valid)
    (by simpa only [C059S038.root_eq_path] using C059S038.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0) root = (236601999279 / 10000000000000) := by
  rw [root_eq_path]
  have h0 : C059S037.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0)
    ...
    simpa only [C059S037.root_eq_path] using C059S037.replay
  have h1 : C059S038.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 0).2 (T.edgePointD1000 0 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 1).2 (T.edgePointD1000 1 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).2 (T.edgePointD1000 2 (165014 / 345015));
       ...
       T) = 0 := by
    simpa only [C059S038.root_eq_path] using C059S038.replay
  calc
    _ = ((236601999279 / 10000000000000) : Rat) + 0 :=
      replay_split h0 h1

...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C046S008
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C046S011

/-!
# exact I6 chamber certificate C046S012
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 1 (1 / 2) C046S008.tree C046S011.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C046S008.root_eq_path] using C046S008.valid)
    (by simpa only [C046S011.root_eq_path] using C046S011.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 0 0) root = (96435268839 / 12500000000000) := by
  rw [root_eq_path]
  have h0 : C046S008.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 0 0)
      (let T := i6D999OrderedPairRoot;
       ...
       T) = (181264135929 / 50000000000000) := by
    simpa only [C046S008.root_eq_path] using C046S008.replay
  have h1 : C046S011.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 0 0)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 0).2 (T.edgePointD1000 0 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 1).2 (T.edgePointD1000 1 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).2 (T.edgePointD1000 2 (165014 / 345015));
       ...
       T) = (204476939427 / 50000000000000) := by
    simpa only [C046S011.root_eq_path] using C046S011.replay
  calc
    _ = ((181264135929 / 50000000000000) : Rat) + (204476939427 / 50000000000000) :=
      replay_split h0 h1

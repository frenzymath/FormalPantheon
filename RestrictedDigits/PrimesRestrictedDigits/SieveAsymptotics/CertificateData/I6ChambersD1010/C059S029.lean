...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C059S027
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C059S028

/-!
# exact I6 chamber certificate C059S029
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 4 (1 / 2) C059S027.tree C059S028.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C059S027.root_eq_path] using C059S027.valid)
    (by simpa only [C059S028.root_eq_path] using C059S028.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0) root = (10960532513 / 4000000000000) := by
  rw [root_eq_path]
  have h0 : C059S027.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0)
      (let T := i6D999OrderedPairRoot;
       ...
       T) = (199673538007 / 100000000000000) := by
    simpa only [C059S027.root_eq_path] using C059S027.replay
  have h1 : C059S028.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 0).2 (T.edgePointD1000 0 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 1).2 (T.edgePointD1000 1 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).2 (T.edgePointD1000 2 (165014 / 345015));
       ...
       T) = (37169887409 / 50000000000000) := by
    simpa only [C059S028.root_eq_path] using C059S028.replay
  calc
    _ = ((199673538007 / 100000000000000) : Rat) + (37169887409 / 50000000000000) :=
      replay_split h0 h1

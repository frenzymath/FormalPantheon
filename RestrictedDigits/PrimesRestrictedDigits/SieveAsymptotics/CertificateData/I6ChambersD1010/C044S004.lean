...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C044S002
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C044S003

/-!
# exact I6 chamber certificate C044S004
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 5 (75002 / 115005) C044S002.tree C044S003.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C044S002.root_eq_path] using C044S002.valid)
    (by simpa only [C044S003.root_eq_path] using C044S003.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 6 0) root = (146907451 / 195312500000) := by
  rw [root_eq_path]
  have h0 : C044S002.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 6 0)
    ...
    simpa only [C044S002.root_eq_path] using C044S002.replay
  have h1 : C044S003.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 6 0)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).1 (T.edgePointD1000 2 (2 / 3));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).1 (T.edgePointD1000 2 (36667 / 76670));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 4).1 (T.edgePointD1000 4 (75002 / 115005));
       ...
       T) = 0 := by
    simpa only [C044S003.root_eq_path] using C044S003.replay
  calc

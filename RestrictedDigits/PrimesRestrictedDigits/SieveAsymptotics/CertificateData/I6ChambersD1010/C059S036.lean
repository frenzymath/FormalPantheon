...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C059S030
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C059S035

/-!
# exact I6 chamber certificate C059S036
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 1 (1 / 2) C059S030.tree C059S035.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C059S030.root_eq_path] using C059S030.valid)
    (by simpa only [C059S035.root_eq_path] using C059S035.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0) root = (530656652217 / 50000000000000) := by
  rw [root_eq_path]
  have h0 : C059S030.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0)
      (let T := i6D999OrderedPairRoot;
       ...
       T) = (142449594613 / 25000000000000) := by
    simpa only [C059S030.root_eq_path] using C059S030.replay
  have h1 : C059S035.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 0).2 (T.edgePointD1000 0 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 1).2 (T.edgePointD1000 1 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).2 (T.edgePointD1000 2 (165014 / 345015));
       ...
       T) = (245757462991 / 50000000000000) := by
    simpa only [C059S035.root_eq_path] using C059S035.replay
  calc
    _ = ((142449594613 / 25000000000000) : Rat) + (245757462991 / 50000000000000) :=
      replay_split h0 h1

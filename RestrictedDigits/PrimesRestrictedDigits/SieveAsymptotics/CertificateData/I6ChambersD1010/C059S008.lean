...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C059S006
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C059S007

/-!
# exact I6 chamber certificate C059S008
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 4 (1 / 2) C059S006.tree C059S007.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C059S006.root_eq_path] using C059S006.valid)
    (by simpa only [C059S007.root_eq_path] using C059S007.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0) root = (265638915493 / 100000000000000) := by
  rw [root_eq_path]
  have h0 : C059S006.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0)
      (let T := i6D999OrderedPairRoot;
       ...
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 3).2 (T.edgePointD1000 3 (1 / 2));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 4).1 (T.edgePointD1000 4 (1 / 2));
       T) = (5727786751 / 4000000000000) := by
    simpa only [C059S006.root_eq_path] using C059S006.replay
  have h1 : C059S007.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 0).2 (T.edgePointD1000 0 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 1).2 (T.edgePointD1000 1 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).2 (T.edgePointD1000 2 (165014 / 345015));
       ...
       T) = (61222123359 / 50000000000000) := by
    simpa only [C059S007.root_eq_path] using C059S007.replay
  calc
    _ = ((5727786751 / 4000000000000) : Rat) + (61222123359 / 50000000000000) :=
      replay_split h0 h1

...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C051S008
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C051S011

/-!
# exact I6 chamber certificate C051S012
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 0 (1 / 2) C051S008.tree C051S011.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C051S008.root_eq_path] using C051S008.valid)
    (by simpa only [C051S011.root_eq_path] using C051S011.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 0 5) root = (610990140501 / 100000000000000) := by
  rw [root_eq_path]
  have h0 : C051S008.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 0 5)
      (let T := i6D999OrderedPairRoot;
       ...
       T) = (32402066943 / 20000000000000) := by
    simpa only [C051S008.root_eq_path] using C051S008.replay
  have h1 : C051S011.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 0 5)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 0).2 (T.edgePointD1000 0 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 1).2 (T.edgePointD1000 1 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).2 (T.edgePointD1000 2 (165014 / 345015));
       ...
       T) = (224489902893 / 50000000000000) := by
    simpa only [C051S011.root_eq_path] using C051S011.replay
  calc
    _ = ((32402066943 / 20000000000000) : Rat) + (224489902893 / 50000000000000) :=
      replay_split h0 h1

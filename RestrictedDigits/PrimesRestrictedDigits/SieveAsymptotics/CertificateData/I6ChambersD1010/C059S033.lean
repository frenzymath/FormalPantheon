...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C059S031
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C059S032

/-!
# exact I6 chamber certificate C059S033
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 4 (1 / 2) C059S031.tree C059S032.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C059S031.root_eq_path] using C059S031.valid)
    (by simpa only [C059S032.root_eq_path] using C059S032.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0) root = (50948224451 / 20000000000000) := by
  rw [root_eq_path]
  have h0 : C059S031.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0)
      (let T := i6D999OrderedPairRoot;
       ...
       T) = (92868478341 / 50000000000000) := by
    simpa only [C059S031.root_eq_path] using C059S031.replay
  have h1 : C059S032.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 0).2 (T.edgePointD1000 0 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 1).2 (T.edgePointD1000 1 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).2 (T.edgePointD1000 2 (165014 / 345015));
       ...
       T) = (69004165573 / 100000000000000) := by
    simpa only [C059S032.root_eq_path] using C059S032.replay
  calc
    _ = ((92868478341 / 50000000000000) : Rat) + (69004165573 / 100000000000000) :=
      replay_split h0 h1

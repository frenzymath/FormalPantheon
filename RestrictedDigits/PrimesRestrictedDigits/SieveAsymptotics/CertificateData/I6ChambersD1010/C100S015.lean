...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C100S001
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C100S014

/-!
# exact I6 chamber certificate C100S015
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 3 (82507 / 115005) C100S001.tree C100S014.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C100S001.root_eq_path] using C100S001.valid)
    (by simpa only [C100S014.root_eq_path] using C100S014.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 3 0) root = (109058364643 / 20000000000000) := by
  rw [root_eq_path]
  have h0 : C100S001.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 3 0)
      (let T := i6D999OrderedPairRoot;
       ...
       T) = 0 := by
    simpa only [C100S001.root_eq_path] using C100S001.replay
  have h1 : C100S014.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 3 0)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).1 (T.edgePointD1000 2 (2 / 3));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 5).1 (T.edgePointD1000 5 (1 / 2));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).1 (T.edgePointD1000 2 (758 / 24395));
    ...
    simpa only [C100S014.root_eq_path] using C100S014.replay
  calc

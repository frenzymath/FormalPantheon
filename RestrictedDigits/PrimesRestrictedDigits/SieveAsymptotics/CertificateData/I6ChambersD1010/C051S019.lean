...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C051S001
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C051S018

/-!
# exact I6 chamber certificate C051S019
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 1 (82507 / 115005) C051S001.tree C051S018.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C051S001.root_eq_path] using C051S001.valid)
    (by simpa only [C051S018.root_eq_path] using C051S018.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 0 5) root = (610990140501 / 100000000000000) := by
  rw [root_eq_path]
  have h0 : C051S001.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 0 5)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 0).2 (T.edgePointD1000 0 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 1).1 (T.edgePointD1000 1 (82507 / 115005));
       T) = 0 := by
    simpa only [C051S001.root_eq_path] using C051S001.replay
  have h1 : C051S018.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 0 5)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 0).2 (T.edgePointD1000 0 (82507 / 115005));
    ...
    simpa only [C051S018.root_eq_path] using C051S018.replay
  calc

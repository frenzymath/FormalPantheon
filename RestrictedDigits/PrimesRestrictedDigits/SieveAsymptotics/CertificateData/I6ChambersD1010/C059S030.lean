...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C059S026
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C059S029

/-!
# exact I6 chamber certificate C059S030
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 3 (1 / 2) C059S026.tree C059S029.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C059S026.root_eq_path] using C059S026.valid)
    (by simpa only [C059S029.root_eq_path] using C059S029.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0) root = (142449594613 / 25000000000000) := by
  rw [root_eq_path]
  have h0 : C059S026.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0)
      (let T := i6D999OrderedPairRoot;
       ...
       T) = (295785065627 / 100000000000000) := by
    simpa only [C059S026.root_eq_path] using C059S026.replay
  have h1 : C059S029.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 5 0)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 0).2 (T.edgePointD1000 0 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 1).2 (T.edgePointD1000 1 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).2 (T.edgePointD1000 2 (165014 / 345015));
       ...
       T) = (10960532513 / 4000000000000) := by
    simpa only [C059S029.root_eq_path] using C059S029.replay
  calc
    _ = ((295785065627 / 100000000000000) : Rat) + (10960532513 / 4000000000000) :=
      replay_split h0 h1

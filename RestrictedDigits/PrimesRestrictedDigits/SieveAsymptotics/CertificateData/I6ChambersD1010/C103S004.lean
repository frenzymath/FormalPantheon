...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C103S002
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C103S003

/-!
# exact I6 chamber certificate C103S004
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 5 (1 / 2) C103S002.tree C103S003.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C103S002.root_eq_path] using C103S002.valid)
    (by simpa only [C103S003.root_eq_path] using C103S003.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 3 6) root = (22724966771 / 12500000000000) := by
  rw [root_eq_path]
  have h0 : C103S002.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 3 6)
    ...
    simpa only [C103S002.root_eq_path] using C103S002.replay
  have h1 : C103S003.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 3 6)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).1 (T.edgePointD1000 2 (2 / 3));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 1).1 (T.edgePointD1000 1 (758 / 3485));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 3).2 (T.edgePointD1000 3 (2576 / 3485));
       ...
       T) = 0 := by
    simpa only [C103S003.root_eq_path] using C103S003.replay
  calc

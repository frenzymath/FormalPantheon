...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C046S012
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C046S015

/-!
# exact I6 chamber certificate C046S016
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 4 (1 / 2) C046S012.tree C046S015.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C046S012.root_eq_path] using C046S012.valid)
    (by simpa only [C046S015.root_eq_path] using C046S015.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 0 0) root = (105403594743 / 10000000000000) := by
  rw [root_eq_path]
  have h0 : C046S012.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 0 0)
      (let T := i6D999OrderedPairRoot;
       ...
       T) = (96435268839 / 12500000000000) := by
    simpa only [C046S012.root_eq_path] using C046S012.replay
  have h1 : C046S015.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 0 0)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 0).2 (T.edgePointD1000 0 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 1).2 (T.edgePointD1000 1 (82507 / 115005));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).2 (T.edgePointD1000 2 (165014 / 345015));
       ...
       T) = (141276898359 / 50000000000000) := by
    simpa only [C046S015.root_eq_path] using C046S015.replay
  calc
    _ = ((96435268839 / 12500000000000) : Rat) + (141276898359 / 50000000000000) :=
      replay_split h0 h1

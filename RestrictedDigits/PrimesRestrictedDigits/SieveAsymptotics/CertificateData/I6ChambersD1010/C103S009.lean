...
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C103S001
import PrimesRestrictedDigits.SieveAsymptotics.CertificateData.I6ChambersD1010.C103S008

/-!
# exact I6 chamber certificate C103S009
-/
...
def tree : RationalTetraClipD1002 16 Rat :=
  .split 4 (2576 / 3485) C103S001.tree C103S008.tree
...
theorem valid :
  ...
  exact valid_split (by decide +kernel) (by decide +kernel)
    (by simpa only [C103S001.root_eq_path] using C103S001.valid)
    (by simpa only [C103S008.root_eq_path] using C103S008.valid)

theorem replay :
    tree.replayWeightRatD1010 (i6D1005ChamberWalls label 3 6) root = (22724966771 / 12500000000000) := by
  rw [root_eq_path]
  have h0 : C103S001.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 3 6)
      (let T := i6D999OrderedPairRoot;
       ...
       T) = 0 := by
    simpa only [C103S001.root_eq_path] using C103S001.replay
  have h1 : C103S008.tree.replayWeightRatD1010 (i6D1005ChamberWalls label 3 6)
      (let T := i6D999OrderedPairRoot;
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 2).1 (T.edgePointD1000 2 (2 / 3));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 1).1 (T.edgePointD1000 1 (758 / 3485));
       let T := T.replaceVertex (RationalTetrahedron.edgeEndpoints 3).2 (T.edgePointD1000 3 (2576 / 3485));
    ...
    simpa only [C103S008.root_eq_path] using C103S008.replay
  calc

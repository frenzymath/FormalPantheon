...
/-!
# Finite bridge for the low-below clean quadruple term
...
private theorem sectionSixFirstLowBelowQuadrupleBuchstabSummand_eq
  ...
  unfold normalizedPrimeLogWeight
    sectionSixFirstLowBelowQuadrupleKernel normalizedPrimeLog
...
theorem sectionSixFirstLowBelowQuadrupleBuchstabMainSum_eq_normalized
    (epsilon : Real) (hepsilon : 0 < epsilon)
    (hepsilonSmall : epsilon <= 1 / 64)
    {length : Nat} (hlength : 1 <= length) :
    sectionSixFirstLowBelowQuadrupleBuchstabMainSum epsilon length =
  ...
  have hpoint : ∀ index ∈ indices,
      buchstabFunction
        ...
        normalizedPrimeLogWeight XNat index.1.1.1 *
          ...
          Real.log X := by
    intro index hindex
    have hquad := mem_sectionSixFirstLowBelowQuadrupleIndices.mp
    ...
    exact sectionSixFirstLowBelowQuadrupleBuchstabSummand_eq hlength
  ...
  rw [← sectionSixFirstLowBelowQuadrupleIndices_map_eq_normalizedPrimeLogFourfoldIndices
